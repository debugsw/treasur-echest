...
//        System.out.println(checkCodeValid("dasda12"));
...
//        System.out.println("耗时 " + (eTime - sTime) / 1000 + "秒");
        ...
        //校验是否合法
        boolean checkRs = checkCodeValid("ABPUEYKLL");
        System.out.println("序列号" + "ABPUEYKLL" + "是否合法：" + checkRs);
        //CDKEY标识
