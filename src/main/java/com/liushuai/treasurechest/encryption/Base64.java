...
import com.liushuai.treasurechest.common.Constant;

import java.io.UnsupportedEncodingException;
import java.util.Arrays;

/**
 * @Description Base64的编码和解码
 * @Author ls
...
public class Base64 {
    ...
    public final static byte[] encodeToByte(String s) {
        try {
            return encodeToByte(s.getBytes(Constant.UTF_8), false);
    ...
    public final static byte[] encodeToByte(String s, boolean lineSep) {
        try {
            return encodeToByte(s.getBytes(Constant.UTF_8), lineSep);
        } catch (UnsupportedEncodingException ignore) {
            return new byte[]{};
        }
    }
    ...
    public final static String decodeToString(byte[] arr) {
        try {
            return new String(decode(arr), Constant.UTF_8);
        } catch (UnsupportedEncodingException ignore) {
            return null;
        }
    }
    ...
    public final static String encodeToString(String s) {
        try {
            return new String(encodeToChar(s.getBytes(Constant.UTF_8), false));
        } catch (UnsupportedEncodingException ignore) {
            return null;
        }
    }
    ...
    public final static String encodeToString(String s, boolean lineSep) {
        try {
            return new String(encodeToChar(s.getBytes(Constant.UTF_8), lineSep));
        } catch (UnsupportedEncodingException ignore) {
            return null;
        }
    }
    ...
    public final static String decodeToString(String s) {
        try {
            return new String(decode(s), Constant.UTF_8);
        } catch (UnsupportedEncodingException ignore) {
            return null;
        }
    }
